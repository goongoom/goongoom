...
function AutocompleteItem({
  ...
  return (
    <AutocompletePrimitive.Item
      className={cn(
        "flex min-h-11 cursor-default select-none items-center rounded-sm px-2 py-1 text-base outline-none data-disabled:pointer-events-none data-highlighted:bg-accent data-highlighted:text-accent-foreground data-disabled:opacity-64 sm:min-h-12 sm:text-sm",
        className,
      )}
